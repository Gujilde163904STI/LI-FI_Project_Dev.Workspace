...
## This version is modified for compatibility with the "MegaCore"
...
#### **`EEPROM.read( address )`** [[*example*]](examples/eeprom*read/eeprom*read.ino)
...
#### **`EEPROM.write( address, value )`** [[*example*]](examples/eeprom*write/eeprom*write.ino)
...
#### **`EEPROM.update( address, value )`** [[*example*]](examples/eeprom*update/eeprom*update.ino)
...
#### **`EEPROM.get( address, object )`** [[*example*]](examples/eeprom*get/eeprom*get.ino)
...
#### **`EEPROM.put( address, object )`** [[*example*]](examples/eeprom*put/eeprom*put.ino)
...
#### **Subscript operator: `EEPROM[address]`** [[*example*]](examples/eeprom*crc/eeprom*crc.ino)
