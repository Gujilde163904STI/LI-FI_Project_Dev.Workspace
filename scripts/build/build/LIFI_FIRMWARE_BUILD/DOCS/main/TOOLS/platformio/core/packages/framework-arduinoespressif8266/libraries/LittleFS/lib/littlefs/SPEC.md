...
*every* type of metadata, including file entries, directory fields, and
...
A quick summary: For every *n*&zwj;th block where *n* is divisible by
2&zwj;*&#739;*, that block contains a pointer to block *n*-2&zwj;*&#739;*.
These pointers are stored in increasing order of *x* in each block of the file
