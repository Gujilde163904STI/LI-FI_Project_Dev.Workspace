...
`MARK` as the second argument when writing, e.g. `write(ch, SWSERIAL*PARITY*MARK)`.
...
[ESP32 data sheet](https://www.espressif.com/sites/default/files/documentation/esp32*datasheet*en.pdf)
