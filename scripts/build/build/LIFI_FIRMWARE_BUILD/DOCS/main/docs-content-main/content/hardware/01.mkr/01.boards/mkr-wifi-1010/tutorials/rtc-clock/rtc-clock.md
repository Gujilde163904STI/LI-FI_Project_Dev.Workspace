...
![Circuit with board and OLED Screen.](assets/mkr*tutorial*10*img*01.png)

### Schematic

![Schematics showing the MKR WiFi 1010 and the SSD1306 OLED.](assets/mkr*tutorial*10*img*02.png)
...
![Time and date on the OLED display.](assets/mkr*tutorial*10*img*03.png)
