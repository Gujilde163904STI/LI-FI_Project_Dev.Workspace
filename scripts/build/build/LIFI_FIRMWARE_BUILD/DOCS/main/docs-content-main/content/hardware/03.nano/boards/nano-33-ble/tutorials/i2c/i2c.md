...
![Reader-Writer circuit, connected with wires and resistors.](./assets/nano33BS*06*illustration.png)
...
First start by connecting your Arduino Nano 33 BLE board to the computer and opening the Arduino Create Cloud Editor. This board will act as the reader. Start a new sketch and name it **Nano*I2C*Reader**. 
...
![Output from Serial Monitor.](./assets/nano33BS*06*printing_values.png)
