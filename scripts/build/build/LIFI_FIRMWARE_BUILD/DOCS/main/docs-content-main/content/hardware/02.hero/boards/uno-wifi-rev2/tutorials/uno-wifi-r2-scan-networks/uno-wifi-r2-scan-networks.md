...
One great feature with the Arduino UNO WiFi Rev2 is the possibility to scan nearby Wi-Fi networks. This is done using the [NINA-W102 radio module](https://content.arduino.cc/assets/Arduino*NINA-W10*DataSheet_%28UBX-17065507%29.pdf), and in this tutorial, we will go through some simple steps to get this working!
...
![The circuit.](assets/UnoWiFiRev2*T4*IMG02.png)
...
![Listing all available networks in the Serial Monitor.](assets/UnoWiFiRev2*T4*IMG03.png)
...
![Routers with their corresponding signal strength.](assets/UnoWiFiRev2*T4*IMG01.png)
