...
![The Arduino® Nano 33 BLE Sense Rev2](assets/Nano33*ble*sense_rev2.png)
...
![Soldering the VUSB pins.](assets/Nano33*ble*sense_vusb.png)

## IMU

![The LSM9DS1 sensor](assets/Nano33*ble*sense_imu.png)
...
To access the data from the IMU system, we need to install the [BMI270*BMM150](https://github.com/arduino-libraries/Arduino*BMI270_BMM150) library, which comes with examples that can be used directly with the Nano 33 BLE Sense Rev2.
...
![The APDS-9960 proximity and gesture sensor](assets/Nano33*ble*sense_gesture.png)
...
![The HS3003 temperature and humidity sensor](assets/Nano33*ble*sense_temperature.png)
...
To access the data from the HS3003 module, we need to install the [Arduino*HS300x](https://github.com/arduino-libraries/Arduino*HS300x) library, which comes with examples that can be used directly with the Nano 33 BLE Sense Rev2.
...
![The LPS22HB pressure sensor](assets/Nano33*ble*sense_pressure.png)
...
![The MP34DT05 microphone](assets/Nano33*ble*sense_microphone.png)
...
![ Bluetooth® module.](assets/Nano33*ble*sense_ble.png)
