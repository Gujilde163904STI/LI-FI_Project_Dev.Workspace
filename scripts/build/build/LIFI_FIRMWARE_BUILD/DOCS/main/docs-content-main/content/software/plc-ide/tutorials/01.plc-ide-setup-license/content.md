...
- [Arduino IDE 1.8.10+](https://www.arduino.cc/en/software), [Arduino IDE 2](https://www.arduino.cc/en/software), [Arduino Cloud Editor](https://create.arduino.cc/editor) or any program with a serial monitor in case you need to retrieve the *Hardware-ID* of your device.
...
`Arduino-PLC-IDE-Installer*X.X.X*Windows_64bit`
...
`Arduino-PLC-IDE-Installer*1.0.6*Windows_64bit`
...
![Online Activation with Forgotten Key](assets/forgot*product*key.png)
...
Double-click on the file *main* inside the *Project* to see the counter program. To download that program to your PLC, you must compile it and send it to the target device.
