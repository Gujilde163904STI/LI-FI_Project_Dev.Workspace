...
![Basics of MQTT.](assets/MKR1000*T3*IMG01.png)
...
![Using encryption with MQTT.](assets/MKR1000*T3*IMG02.png)
...
![Circuit showing publisher and subscriber boards.](assets/MKR1000*T3*IMG03.png)
...
![Creating a new tab.](assets/MKR1000*T3*IMG04.png)

Then, name the file "arduino_secrets.h".

![Naming the file.](assets/MKR1000*T3*IMG05.png)
...
![Selecting the right port.](assets/MKR1000*T3*IMG06.png)
...
![Serial Monitor output of publisher device.](assets/MKR1000*T3*IMG07.png)
...
![Serial Monitor output of subscriber device.](assets/MKR1000*T3*IMG08.png)
