...
- [Nicla Voice and Portenta H7 3D Printed enclosures](assets/Intruder*Detector*3D_Files.zip)
...
- The [intruder detector example code](assets/Nicla*Portenta*Codes.zip).
...
![Raw audio samples and their spectrograms](assets/samples*dsp*white.png)
...
![Neural Network Configuration](assets/nn*setup*white.png)
...
For a new model deployment, use the [Syntiant® uploader](assets/Syntiant*Uploader.zip) and replace the `ei*model.synpkg`, which you can file inside the downloaded folder with yours.
...
- mcu*fw*120_v91.synpkg
- dsp*firmware*v91.synpkg
- ei_model.synpkg
...
* The complete code can be downloaded [**here**](assets/Nicla*Portenta*Codes.zip)
* The enclosure 3D printed models can be downloaded [**here**](assets/Intruder*Detector*3D_Files.zip). 
