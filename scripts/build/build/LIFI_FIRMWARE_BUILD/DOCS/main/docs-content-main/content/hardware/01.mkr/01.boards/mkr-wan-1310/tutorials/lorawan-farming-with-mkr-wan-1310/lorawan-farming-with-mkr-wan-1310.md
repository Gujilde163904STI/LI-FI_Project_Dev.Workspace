...
![The final hardware setup.](assets/setup*hw*JBeVsDaYY4.png)
...
- The Arduino*JSON library is used to parse the *downlink_ message from TTN
...
![You should see a page like this one.](assets/screenshot*2019-04-15*16-55-07_1XeopaUVkG.png)

Now you'll have to install additional palettes (kinda plugins) in order to:

- Connect to The Things Network (TTN) to retrieve *uplinks* from the MKR WAN 1300 and MKR WAN 1310 and send back *downlink* messages.
...
![Choose manage palette.](assets/screenshot*2019-03-11*16-13-31_f3NoezOSyz.png)
...
![Click on install and search for "ttn".](assets/screenshot*2019-04-15*13-06-26*2*BFc2L1dPAk.png)

You have also to confirm the installation

![Confirm the installation.](assets/screenshot*2019-04-15*13-06-43_VIadaZm4HV.png)
...
![ttn Nodes.](assets/screenshot*2019-04-15*17-13-03_rnXWpyIP2c.png)
...
![Drag the node into the flow.](assets/screenshot*2019-04-15*22-48-35_QFUcphj0pD.png)
...
![Copy your API key.](assets/screenshot*2019-04-16*17-54-41_fELtZEaTr2.png)
