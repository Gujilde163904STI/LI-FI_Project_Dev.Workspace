...
![Power architecture of the UNO SPE Shield](assets/SPE*SHIELD*POWER_TREE.png)
...
![Pinout of the UNO SPE Shield](assets/UNO*SPE*Pinout.png)

### Block Diagram

An overview of the UNO SPE Shield high-level architecture is illustrated in the figure below:

![Block diagram of the UNO SPE Shield](assets/SPE*Shield*Block_Diagram.png)
...
| U3*1, U3*2  | High-Side Power Switch                                 |
