...
![The LSM9DS1 sensor.](./assets/nano33BLE*01*IMU.png)
...
![How the accelerometer works.](./assets/nano33BLE*01*acceleration.png)
...
![Finding the library in the Cloud Editor.](./assets/nano33BLE*01*include_library.png)
...
![Selecting the board.](assets/nano33BLE*01*board_port.png)
...
![Interacting with the X and Y axes.](./assets/nano33BLE*01*illustration.png)
...
![Printing out the "tilt condition" of the board.](./assets/nano33BLE*01*printing_values.png)
