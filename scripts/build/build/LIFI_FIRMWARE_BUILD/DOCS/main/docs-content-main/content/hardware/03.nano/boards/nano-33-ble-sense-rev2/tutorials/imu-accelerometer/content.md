...
![The Arduino Nano 33 BLE Sense Rev2 IMU system.](./assets/nano33BS*02*IMU.png)
...
If you want to read more about the sensor modules that make up the IMU system, find the datasheet for the <a href="https://docs.arduino.cc/resources/datasheets/bst-bmi270-ds000.pdf" target="*blank">BMI270</a> and the <a href="https://docs.arduino.cc/resources/datasheets/bst-bmm150-ds001.pdf" target="*blank">BMM150</a> here.
...
![How the accelerometer works.](./assets/nano33BS*02*acceleration.png)
...
Let's start by opening the Arduino Cloud Editor, click on the **Libraries** tab and search for the **BMI270_BMM150** library. Then in **> Examples**, open the **SimpleAccelerometer** sketch and once it opens, rename it as **Accelerometer**.

![Finding the library in the Cloud Editor.](./assets/nano33BS*02*include_library.png)
...
![Selecting the board.](assets/nano33BS*02*board_port.png)
...
![Interacting with the X and Y axes.](./assets/nano33BS*02*illustration.png)
...
![Printing out the "tilt condition" of the board.](./assets/nano33BS*02*printing_values.png)
