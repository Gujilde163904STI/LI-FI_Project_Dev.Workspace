...
![The Arduino® Nano 33 BLE Sense](assets/Nano33*ble*sense.png)
...
![The HTS221 temperature and humidity sensor](assets/Nano33*ble*sense_temperature.png)
...
- [Reading Temperature & Humidity on Nano 33 BLE Sense](https://docs.arduino.cc/tutorials/nano-33-ble-sense/humidity*and*temperature_sensor)
