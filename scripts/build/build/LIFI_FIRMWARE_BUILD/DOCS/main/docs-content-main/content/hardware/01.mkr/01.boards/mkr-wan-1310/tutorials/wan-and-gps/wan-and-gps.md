...
There is, of course, much more behind the GPS technology. If we want to read more, why not start at [NASA's own article](https://www.nasa.gov/directorates/heo/scan/communications/policy/what*is*gps) on how GPS works.

### Circuit

![Simple circuit showing the sender and GPS Shield with the antenna.](assets/WAN1310*T5*IMG01.png)
...
![Sending GPS data.](assets/WAN1310*T5*IMG03.png)
...
![Serial Monitor view of both devices.](assets/WAN1310*T5*IMG02.png)
