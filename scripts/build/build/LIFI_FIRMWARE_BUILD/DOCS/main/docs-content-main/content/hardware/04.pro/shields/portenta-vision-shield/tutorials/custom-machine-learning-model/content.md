...
coverImage: assets/vs*openmv*ml_cover.svg
...
![For supervised learning objects are labeled beforehand with their names](assets/vs*openmv*ml*supervised*learning.svg)
...
![The Dataset Editor can be found in the Tools menu](assets/vs*openmv*ml*new*dataset.png)
...
![The various image classes can be created directly in the dataset editor](assets/vs*openmv*ml_classes.png)
...
![You need to log in with your Edge Impulse® account when uploading a dataset for the first time](assets/vs*openmv*ml*edge*impulse_login.png)
...
![The Data Acquisition tool allows to inspect the uploaded assets](assets/vs*openmv*ml*edge*impulse_data.png)
...
![An Impulse consists of the building blocks needed to train a ML model](assets/vs*openmv*ml*edge*impulse_design.png)
...
![In the image inspection tool you can set the color depth according to the input data](assets/vs*openmv*ml*edge*impulse_parameters.png)
...
![The feature explorer allows to visually inspect the clusters of images in regards to their properties](assets/vs*openmv*ml*edge*impulse_features.png)
...
![The confusion matrix shows the accuracy of the ML model after the last training cycle](assets/vs*openmv*ml*edge*impulse_training.png)
...
![The Edge Impulse® Studio has a built-in export function for OpenMV](assets/vs*openmv*ml*edge*impulse_build.png)

### Run the Script

The final step concerns running the **ei*image*classification.py** script. Open it in the OpenMV and replace the print statement in the innermost for loop with the following code:
...
![In this example the apple is detected with a 100% certainty](assets/vs*openmv*ml*edge*impulse_classification.png)
