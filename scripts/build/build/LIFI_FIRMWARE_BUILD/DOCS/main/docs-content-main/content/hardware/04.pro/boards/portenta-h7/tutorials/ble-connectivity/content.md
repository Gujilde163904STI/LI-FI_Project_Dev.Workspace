...
coverImage: assets/por*ard*ble_cover.svg
difficulty: beginner
tags:
...
![BLE Configuration Scheme](assets/por*ard*ble_configuration.svg) 
...
![The Portenta H7 can be connected to the computer using an appropriate USB-C® cable](assets/por*ard*ble*basic*setup.svg)
