...
![CMWX1ZZABZ-078 LPWAN module in the Portenta Max Carrier.](assets/mc*ard*ttn_module.png)
...
![CMWX1ZZABZ-078 module with LoRa® technology on the Portenta Max Carrier.](assets/mc*ard*hd*ttn*connectors.png)
...
![Power sources and LoRa® antenna connector on the Portenta Max Carrier.](assets/mc*ard*ttn_power.png)
...
![BOOT DIP Switches on the Portenta Max Carrier.](assets/mc*ard*ttn*boot*sel.png)
...
![Library Manager in the Arduino IDE 2.](assets/mc*ard*ttn_library.png)

***Currently, there are two versions of the MKRWAN library. We recommend using the MKRWAN*v1 library since MKRWAN*v2 library is still in beta phase.***
...
The LPWAN module firmware of the Portenta Max Carrier **must be updated** before its first use. This can be done using the example sketch `MKRWANFWUpdate*standalone` of the MKRWAN library. You can open this example by navigating to **File > Examples > MKRWAN**. Before uploading the sketch to the Portenta H7 board, open the `MKRWANFWUpdate*standalone.ino` file and define `PORTENTA_CARRIER` before the library inclusion, as shown in the image below:

![Library Manager in the Arduino IDE 2.](assets/mc*ard*ttn*firmware*1.png)
...
![TTN console welcome page.](assets/mc*ard*ttn*console*1.png)
...
![Application dashboard in TTN.](assets/mc*ard*ttn*console*2.png)
...
![Registering an end device in TTN.](assets/mc*ard*ttn*console*3.png)
...
![Device overview in TTN.](assets/mc*ard*ttn*console*4.png)
