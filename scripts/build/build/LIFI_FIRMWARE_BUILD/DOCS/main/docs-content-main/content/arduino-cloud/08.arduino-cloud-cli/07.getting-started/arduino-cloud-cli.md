...
* `arduino:samd:nano*33*iot` [Arduino Nano 33 IoT](https://docs.arduino.cc/hardware/nano-33-iot)
...
* `arduino:mbed*portenta:envie*m7` [Arduino Portenta H7](https://docs.arduino.cc/hardware/portenta-h7) / [Arduino Portenta H7 Lite connected](https://docs.arduino.cc/hardware/portenta-h7-lite-connected) / [Arduino Portenta Machine Control](https://docs.arduino.cc/hardware/portenta-machine-control)
* `arduino:mbed*nicla:nicla*vision` [Arduino Nicla Vision](https://docs.arduino.cc/hardware/nicla-vision)
