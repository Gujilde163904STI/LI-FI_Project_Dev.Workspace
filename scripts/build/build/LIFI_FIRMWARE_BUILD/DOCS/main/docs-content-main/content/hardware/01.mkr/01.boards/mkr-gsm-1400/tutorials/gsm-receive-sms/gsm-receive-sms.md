...
![A simple circuit with the board and antenna.](assets/MKRGSM*T4*IMG01.png)
...
![Offline IDE waiting for messages.](assets/MKRGSM*T4*IMG02.png)
...
![SMS received, printed in the Serial Monitor.](assets/MKRGSM*T4*IMG03.png)
