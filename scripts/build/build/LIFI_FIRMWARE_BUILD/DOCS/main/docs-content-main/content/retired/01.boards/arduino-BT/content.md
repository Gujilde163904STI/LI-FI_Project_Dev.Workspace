...
![Arduino BT Front](assets/ArduinoBT*Front*400px.jpg)

![Arduino BT Back](assets/ArduinoBT*Back*400px.jpg)
...
Reference Design: [Eagle\*File\*Arduino\_BT.zip](//www.arduino.cc/en/uploads/Main/Arduino%5FBT.zip)   
