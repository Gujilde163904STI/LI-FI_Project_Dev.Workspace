...
![Simple circuit with board, shield and antenna.](assets/MKRGSM*T7*IMG01.png)
...
![Subscribing to environmental data in the serial monitor.](assets/MKRGSM*T7*IMG02.png)
