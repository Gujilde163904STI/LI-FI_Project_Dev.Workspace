...
![Portenta Max Carrier with the Portenta X8 & Pro 4G Module](assets/portentaMAXcarrier*modem*test.png)
...
![Portenta Max Carrier Power Jack](assets/portentaMAXcarrier*power*distro.png)
...
![Mini PCIe Interface on the Portenta Max Carrier](assets/portentaMAXcarrier*mpcie*connector.png)
...
![Portenta Max Carrier & PRO 4G Module](assets/portentaMAXcarrier*module*setup.png)
...
|       20       |        N/A         |                 |         ANALOG*A1         |                                J2-75                                 |                     W*DISABLE                     |
...
![Portenta Max Carrier & PRO 4G GNSS Module Global](assets/portentaMAXcarrier*mpcie*pinout.png)
...
![Portenta Max Carrier & Mini PCIe Setup](assets/portentaMAXcarrier*mpcie*set.png)
...
![Arduino PRO 4G GNSS Module](assets/portenta4G*module*struct.png)
...
![Portenta Max Carrier Mini PCIe & Portenta X8 Setup](assets/portentaMAXcarrier*complete*setup.png)
...
![Portenta Max Carrier Mini PCIe Module Listing](assets/portentaMAXcarrier*mpcie*list.png)
...
![PRO 4G GNSS Module OOTB Activation - Main Page](assets/portentaMAXcarrier*modem*main.png)

In this dashboard, you will find the **Settings** option. Please click on this option to proceed to the next step.

![PRO 4G GNSS Module OOTB Activation - Settings Option](assets/portentaMAXcarrier*modem*options.png)

In the **Settings**, choose the **LTE/4G Sim** option to start configuring the modem.

![PRO 4G GNSS Module OOTB Activation - Modem Parameters](assets/portentaMAXcarrier*modem*init.png)
...
![PRO 4G GNSS Module OOTB Activation - Network Status](assets/portentaMAXcarrier*modem*netStat.png)
...
![PRO 4G GNSS Module OOTB Activation - System Information](assets/portentaMAXcarrier*modem*sysInfo.png)
...
![Portenta Max Carrier mPCIe Overlay Configuration - Main](assets/portentaMAXcarrier*mpcie*1.png)
...
![Portenta Max Carrier mPCIe Overlay Configuration - Overlays](assets/portentaMAXcarrier*mpcie*2.png)

It will open a new window displaying the **Adds Mini-PCIE support** option. Please select the **Adds Mini-PCIE support** option.

![Portenta Max Carrier mPCIe Overlay Configuration - Mini PCIe](assets/portentaMAXcarrier*mpcie*3.png)

It will prompt a message showing a new set of overlays that will be applied once modified.

![Portenta Max Carrier mPCIe Overlay Configuration - Applied Changes](assets/portentaMAXcarrier*mpcie*4.png)

Select **Ok** to confirm, and the device will be configured with the overlays for mini PCIe support.

![Portenta Max Carrier mPCIe Overlay Configuration - Change Set](assets/portentaMAXcarrier*mpcie*5.png)
...
***__NOTE:__ The `ov*carrier*max*pcie*mini` overlay is __not required for modems__ such as the __GNSS Global (EG25)__ and __EMEA (EC200A-EU)__ variants of the Pro 4G Module, as these modems rely on the USB interface and not on the PCIe bus.***
...
![PRO 4G GNSS Module - Card Status](assets/portentaMAXcarrier*mpcie*card_status.png)

```bash
qmicli --device=/dev/cdc-wdm0 --device-open-proxy --wds-start-network="ip-type=4,apn=iot.1nce.net" --client-no-release-cid
```

![PRO 4G GNSS Module - Network Initialization](assets/portentaMAXcarrier*mpcie*network_start.png)
...
![PRO 4G GNSS Module - Dynamic IP Configuration](assets/portentaMAXcarrier*mpcie*dynamic.png)
...
![Arduino Pro 4G Module - Speed Test](assets/portentaMAXcarrier*modem*test.png)
