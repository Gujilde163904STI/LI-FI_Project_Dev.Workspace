...
![The LSM9DS1 sensor.](./assets/nano33BLE*03*IMU.png)
...
![How a magnetometer works.](./assets/nano33BLE*03*magnetometer.png)
...
![Finding the library in the Cloud Editor.](./assets/nano33BLE*03*include_library.png)
...
![Selecting the board.](./assets/nano33BLE*03*board_port.png)
...
![Checking for magnetic disturbance.](./assets/nano33BLE*03*illustration.png)
