...
[ARDUINO MINI 05](https://www.arduino.cc/en/uploads/Main/arduino*mini*schematic05.pdf)
[ARDUINO MINI 04](https://www.arduino.cc/en/uploads/Main/arduino*mini*schematic04.pdf)
[ARDUINO MINI 03](https://www.arduino.cc/en/uploads/Main/arduino*mini*schematic03.pdf)
...
The ATmega328 on the Arduino Mini comes preburned with a [bootloader](https://www.arduino.cc/en/Tutorial/Bootloader) that allows you to upload new code to it without the use of an in-system-programmer. The bootloader communicates using the original STK500 protocol ([reference](http://www.atmel.com/dyn/resources/prod*documents/doc2525.pdf), [C header files](http://www.atmel.com/dyn/resources/prod*documents/avr061.zip)).
