...
![How RGB LEDs work.](assets/MKR*1010*T12_IMG01.png)
...
![The RGB on board the MKR WiFi 1010 board.](assets/MKR*1010*T12_IMG02.png)
...
![The MKR WiFi 1010 board.](assets/MKR*1010*T12_IMG03.png)
...
- `#include <utility/wifi*drv.h>` - includes the `wifi*drv.h` file.
...
![Pins and brightness values.](assets/MKR*1010*T12_IMG04.png)
