...
![Agriculture Application Example Setup](assets/EDGE*CONTROL*DIAGRAM1.png)
...
|:-------------------------:|:-----------------------------------:|
|      0 - 5 V Channel 1     |           INPUT*05V*CH01          |
|      0 - 5 V Channel 2     |           INPUT*05V*CH02          |
|      0 - 5 V Channel 3     |           INPUT*05V*CH03          |
|      0 - 5 V Channel 4     |           INPUT*05V*CH04          |
|      0 - 5 V Channel 5     |           INPUT*05V*CH05          |
|      0 - 5 V Channel 6     |           INPUT*05V*CH06          |
|      0 - 5 V Channel 7     |           INPUT*05V*CH07          |
|      0 - 5 V Channel 8     |           INPUT*05V*CH08          |
...
This example code can also be found on **File > Examples > Arduino*EdgeControl > Basic > 0-5V*Input**.
...
|          **Input Name**          |         **Arduino Pin Mapping**       |
|:--------------------------------:|:-------------------------------------:|
|      4 - 20 mA Sensor Input 1     |           INPUT*420mA*CH01          |
|      4 - 20 mA Sensor Input 2     |           INPUT*420mA*CH02          |
|      4 - 20 mA Sensor Input 3     |           INPUT*420mA*CH03          |
|      4 - 20 mA Sensor Input 4     |           INPUT*420mA*CH04          |
...
- **8x Latching Outputs** with mosfet drivers, mapped as follows: 
  ...
  |:----------------------------:|:-----------------------------------:|
  |      Latching Output 1     |           LATCHING*OUT*1          |
  |      Latching Output 2     |           LATCHING*OUT*2          |
  |      Latching Output 3     |           LATCHING*OUT*3          |
  |      Latching Output 4     |           LATCHING*OUT*4          |
  |      Latching Output 5     |           LATCHING*OUT*5          |
  |      Latching Output 6     |           LATCHING*OUT*6          |
  |      Latching Output 7     |           LATCHING*OUT*7          |
  |      Latching Output 8     |           LATCHING*OUT*8          |
...
- **8x Latching Commands** without drivers, mapped as follows: 
  ...
  |        **Output Name**        |       **Arduino Pin Mapping**       |
  |:----------------------------:|:-----------------------------------:|
  |      Latching Command 1     |           LATCHING*CMD*1          |
  |      Latching Command 2     |           LATCHING*CMD*2          |
  |      Latching Command 3     |           LATCHING*CMD*3          |
  |      Latching Command 4     |           LATCHING*CMD*4          |
  |      Latching Command 5     |           LATCHING*CMD*5          |
  |      Latching Command 6     |           LATCHING*CMD*6          |
  |      Latching Command 7     |           LATCHING*CMD*7          |
  |      Latching Command 8     |           LATCHING*CMD*8          |
...
The NINA-B306 has two I2C ports. The `I2C*1` is shared with the internal components and the MKR1 header, and the `I2C*2` is exclusively connected to the MKR2 header.

![Edge Control I2C Pins on MKR Connectors](assets/i2c-pins.png)

***Use `Wire` to communicate with MKR1 (`I2C*1`), and `Wire1` to communicate with MKR2 (`I2C*2`).***
