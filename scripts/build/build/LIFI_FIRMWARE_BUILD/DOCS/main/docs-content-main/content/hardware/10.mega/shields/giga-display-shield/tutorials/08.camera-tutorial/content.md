...
The Arduino Mbed OS Giga Boards Board Package contains most of the libraries you need to work with the shield's camera connector. To install the Board Package for GIGA boards, navigate to **Tools > Board > Boards Manager** or click the Boards Manager icon in the left tab of the IDE. In the Boards Manager tab, search for giga and install the latest Arduino Mbed OS Giga Boards version, the [Arduino*H7*Video library](https://github.com/arduino/ArduinoCore-mbed/tree/main/libraries/Arduino*H7*Video) library is included in the Board Package. Now open the library tab on the left, search for [**Arducam*dvp**](https://www.arduino.cc/reference/en/libraries/arducam*dvp/), and install this library.
...
- HM01B0: `#define ARDUCAM*CAMERA*HM01B0`
- HM0360: `#define ARDUCAM*CAMERA*HM0360`
- GC2145: `#define ARDUCAM*CAMERA*GC2145`
- OV7675: `#define ARDUCAM*CAMERA*OV767x`
