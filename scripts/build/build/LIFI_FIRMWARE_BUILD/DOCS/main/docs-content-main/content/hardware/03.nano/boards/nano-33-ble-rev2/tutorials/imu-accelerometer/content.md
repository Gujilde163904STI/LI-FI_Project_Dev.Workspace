...
![The Nano 33 BLE Rev2 IMU system.](./assets/Nano33*ble*rev2_imu.png)
...
![How the accelerometer works.](./assets/nano33B*02*acceleration.png)
...
Let's start by opening the Arduino Cloud Editor, clicking on the **Libraries** tab, and searching for the **Arduino*BMI270*BMM150** library. Then, in **Examples**, open the **SimpleAccelerometer** sketch and once it opens, rename it as **Accelerometer**.

![Finding the library in the Cloud Editor.](./assets/nano33B*02*include_library.png)
...
![Selecting the board.](assets/nano33B*02*board_port.png)
...
![Interacting with the X and Y axes.](./assets/nano33B*02*illustration.png)
...
![Printing out the "tilt condition" of the board.](./assets/nano33B*02*printing_values.png)
