...
![System overview of Opta™ with Modbus RTU using PLC IDE](assets/opta*plcide*modbusrtu_overview.png)
...
- [Opta™ Modbus RTU PLC IDE Project Example File](assets/ModbusRTU*Opta*Example.zip)
...
![RS-485 interface between Opta™ devices for Modbus RTU](assets/opta*rtu*plcide*hardware*connection.png)
...
![Arduino PLC IDE - General Modbus Node Configuration](assets/opta*plcide*generalNode.png)
...
![Arduino PLC IDE - Modbus Custom Editor Configuration](assets/opta*plcide*customModbus.png)
...
You may access the entire example project [here](assets/ModbusRTU*Opta*Example.zip) to test it immediately. Every setting and component is ready to be assembled and uploaded to the corresponding Opta™.
...
![Arduino PLC IDE - Opta™ Modbus RTU Server Configuration](assets/opta*plcide*server_modbusMainConfig.png)
...
![Arduino PLC IDE - Opta™ Server Status Variable](assets/opta*plcide*server_statVar.png)
...
![Arduino PLC IDE - Device Connection Procedure (Modbus TCP Server Opta™)](assets/opta*plcide*device_connection.gif)
...
![Arduino PLC IDE - Opta™ Server Main Code](assets/opta*plcide*server_mainCode.png)
...
![Arduino PLC IDE - Opta™ Modbus RTU Client Configuration](assets/opta*plcide*client_modbusMainConfig.png)
...
![Arduino PLC IDE - Opta™ Client Node](assets/opta*plcide*client_nodeConfig.png)

Once you have established the Modbus node for the client Opta™, it is time to determine the Modbus function to fetch the counter (`cnt`) data from the server Opta™. Right-click on `Opta*RTU*1` or any other name you set with, and the 'Add' option will show up, displaying a device catalog window with all available Modbus functions:

![Arduino PLC IDE - Modbus Functions](assets/opta*plcide*modbus_functions.png)
...
![Arduino PLC IDE - Opta™ Client Modbus Function of the Node](assets/opta*plcide*client_modbusFunctionConfig.png)
...
![Arduino PLC IDE - Opta™ Client Modbus Function of the Node (Input Reg.)](assets/opta*plcide*client*modbusFunctionConfig*reg.png)
...
![Arduino PLC IDE - Opta™ Client Status LED Table](assets/opta*plcide*client_ledSet.png)
...
![Arduino PLC IDE - Opta™ Client Relay Table](assets/opta*plcide*client_relaySet.png)
...
You can access the complete example project [here](assets/ModbusRTU*Opta*Example.zip). You can download the compressed file, extract it, and use the pre-configured example project for your Opta™ devices.
...
![Example Project Result](assets/opta*plcide*rtu*example*result.gif)
