...
![Attaching the shield.](assets/WAN1310*T2*IMG01.png)

Follow the wiring diagram below to connect the antennas to the MKR WAN 1310 boards.

![Simple circuit of the sender and receiver board with antenna.](assets/WAN1310*T1*IMG01.png)

### Schematic 

This is the schematic of our circuit.

![Simple schematics of the circuit.](assets/WAN1310*T1*IMG02.png)
...
![Sending packets.](assets/WAN1310*T2*IMG04.png)
...
![Receiving packets.](assets/WAN1310*T2*IMG05.png)
