...
![Attaching the shield to the board.](assets/WAN1300*T2*IMG01.png)

Follow the wiring diagram below to connect the antennas to the MKR WAN 1300 boards.

![Simple Sender and Receiver circuits.](assets/WAN1300*T2*IMG02.png)
...
![Sending packets.](assets/WAN1300*T2*IMG04.png)
...
![Receiving the environmental data.](assets/WAN1300*T2*IMG05.png)
