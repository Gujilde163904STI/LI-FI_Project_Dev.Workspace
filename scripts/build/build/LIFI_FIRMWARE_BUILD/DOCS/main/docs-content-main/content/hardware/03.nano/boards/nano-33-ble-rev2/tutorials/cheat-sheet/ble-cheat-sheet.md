...
![Soldering the VUSB pins.](./assets/Nano33*ble*rev2vusb.png)

## IMU

![IMU sensor](./assets/Nano33*ble*rev2_imu.png)
...
To access the data from the IMU system, we need to install the [BMI270*BMM150](https://github.com/arduino-libraries/Arduino*BMI270_BMM150) library, which comes with examples that can be used directly with the Nano 33 BLE Rev2.
...
![ Bluetooth module.](assets/Nano33*ble*rev2_ble.png)
