...
![Simple circuit of the board and antenna.](assets/WAN1310*T6*IMG00.png)
...
***Note that there is also a library named MKRWAN*v2 from Arduino. We used the MKRWAN library for this tutorial, but both libraries work. As the two libraries rely on two separate firmware, it is important that your device has the correct firmware installed. Updating it is done by running the File > Examples > MKRWAN / MKRWAN*v2 > MKRWANFWUpdate_standalone example from the corresponding library. This note was last updated 2022/02/16.***
...
![The device EUI.](assets/WAN1310*T6*IMG01.png)
...
![Select Create an application](assets/WAN1310*T6*IMG02.png)
...
![Adding an application](assets/WAN1310*T6*IMG04.png)
...
![Registering a Device](assets/WAN1310*T6*IMG05.png)
...
![First step of registering device](assets/WAN1310*T6*IMG06.png)
...
![Second step of registering device](assets/WAN1310*T6*IMG06_02.png)
...
![The Things Network Device Overview](assets/WAN1310*T6*IMG07.png)

**Note**: For devices using the **AU*915*928** band plan, an additional
...
![Using Arduino IDE to run the FirstConfiguration sketch](assets/WAN1310*T6*IMG08.png)
...
![Connecting to TTN with Arduino IDE](assets/WAN1310*T6*IMG09.png)
...
![Failure to connect to TTN.](assets/WAN1310*T6*IMG10.png)
...
![Successful connection.](assets/WAN1310*T6*IMG12.png)
...
![Payload tab in The Things Network console.](assets/WAN1310*T6*IMG13.png)
