...
![The IMU system on the Arduino Nano 33 BLE Sense Rev2.](./assets/nano33BS*04*IMU.png)
...
### The Library
The [Arduino BMI270*BMM150 library](https://www.arduino.cc/reference/en/libraries/arduino*bmi270_bmm150/) allows us to use the Arduino Nano 33 BLE Sense Rev2 IMU module without having to go into complicated programming. The library takes care of the sensor initialization and sets its values as follows:
