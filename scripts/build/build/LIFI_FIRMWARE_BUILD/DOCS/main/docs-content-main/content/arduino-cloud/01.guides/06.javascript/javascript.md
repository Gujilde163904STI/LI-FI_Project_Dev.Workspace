...
Create a file with a `.js` extension, and call it something appropriate such as `cloud*first*test.js`. Note that it needs to be in the same directory as you installed the library.
