...
![The LSM9DS1 sensor.](./assets/nano33BLE*02*IMU.png)
...
![How gyroscopes work.](./assets/nano33BLE*02*gyroscope.png)
...
![Finding the library in the Cloud Editor.](./assets/nano33BLE*02*include_library.png)
...
![Selecting the board.](assets/nano33BLE*02*board_port.png)
...
![Positioning of the board.](./assets/nano33BLE*02*illustration.png)
...
![Serial Monitor output.](./assets/nano33BLE*02*printing_values.png)
