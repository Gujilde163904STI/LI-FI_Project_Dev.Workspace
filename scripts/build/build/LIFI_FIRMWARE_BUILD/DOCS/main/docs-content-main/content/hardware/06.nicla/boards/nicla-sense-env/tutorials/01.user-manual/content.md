...
The [`Arduino*NiclaSenseEnv` library](https://github.com/arduino-libraries/Arduino*NiclaSenseEnv) contains an application programming interface (API) to read data from the board and control its parameters and behavior over I²C. This library supports the following: 
...
To install the `Arduino*NiclaSenseEnv` library, navigate to `Tools > Manage libraries...` or click the **Library Manager** icon in the left tab of the Arduino IDE. In the Library Manager tab, search for `Arduino*NiclaSenseEnv` and install the latest version of the library.
...
You can download the example sketch [here](assets/nicla*sense*env*board*info_example.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*sensors*management_example.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*board*reset_example.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*low*power*mode*example.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*orange*led*control*example.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*rgb*led*control*example_brightness.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*temp*humidity_example.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*indoor*air*quality*example.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*outdoor*air*quality*example.zip).
...
You can download the example sketch [here](assets/nicla*sense*env*uart*communication_example.zip).
