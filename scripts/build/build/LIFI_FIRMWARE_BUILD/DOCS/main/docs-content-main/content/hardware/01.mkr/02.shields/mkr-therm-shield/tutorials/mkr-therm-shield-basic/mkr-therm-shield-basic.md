...
![Mounting the shield.](assets/MKR*THERM*T1_IMG01.png)

Then, we need to connect the thermocoupler to the shield.

![Connecting a one-wire thermocoupler to the shield.](assets/MKR*THERM*T1_IMG02.png)
...
![Reference temperature and temperature recorded through the thermocouple.](assets/MKR*THERM*T1_IMG03.png)
