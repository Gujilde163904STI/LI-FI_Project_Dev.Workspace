...
- [Packaging and Labeling Systems PLC Program](assets/Packaging*and*labeling.zip)
...
[![ ](assets/download.png)](assets/Packaging*and*labeling.zip)

Download the whole project code including the PLC IDE program [here](assets/Packaging*and*labeling.zip).
...
| ------------------ | ------------------ | ------------------------ | ---------------- | ------------------- |
| Servodriver*Axis*X | 1                  | 1                        | Modbus           | Little endian       |
| Servodriver*Axis*X | 2                  | 1                        | Modbus           | Little endian       |
| Servodriver*Axis*X | 3                  | 1                        | Modbus           | Little endian       |
...
You can download the code for the Opta [here](assets/Packaging*and*labeling.zip).
...
***You can download the complete code from [here](assets/Packaging*and*labeling.zip).***
...
- The complete code can be downloaded [here](assets/Packaging*and*labeling.zip)
