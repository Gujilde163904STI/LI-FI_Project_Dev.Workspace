...
![Custom Branding - Custom URL (White Labeling)](assets/custom-branding-3-1.png)
  ...
  - **Social Sign-in:** By enabling *Social Sign-In*, you can offer faster authentication to your app. The available options for *Social Sign-In* are Google, GitHub, and Apple. **To enable this option, You must first complete the *Custom URL* information. Otherwise, this feature will not be available.**
