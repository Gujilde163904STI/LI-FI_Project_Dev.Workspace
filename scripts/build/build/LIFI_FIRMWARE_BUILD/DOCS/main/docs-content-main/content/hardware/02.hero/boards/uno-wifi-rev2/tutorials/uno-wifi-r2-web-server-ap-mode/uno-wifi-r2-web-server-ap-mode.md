...
![The circuit.](assets/UnoWiFiRev2*T3*IMG01.png)
...
![Information printed in the Serial Monitor.](assets/UnoWiFiRev2*T3*IMG02.png)
...
![Finding the board and connecting to it.](assets/UnoWiFiRev2*T3*IMG03.png)
...
![Accessing the board through the browser.](assets/UnoWiFiRev2*T3*IMG04.png)
...
![Client is connected.](assets/UnoWiFiRev2*T3*IMG05.png)
