...
![Alvik's Main Components](assets/datasheet*main*components.png)
...
| ------------------- | ---------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| STM32F411RC         | [Link](https://www.st.com/en/microcontrollers-microprocessors/stm32f411rc.html#st*description*sec-nav-tab) | [Link](assets/STM32_datasheet.pdf)                                          |
...
![Alvik's DC Motor Technical Specs](assets/dc*motor*specs.png)
