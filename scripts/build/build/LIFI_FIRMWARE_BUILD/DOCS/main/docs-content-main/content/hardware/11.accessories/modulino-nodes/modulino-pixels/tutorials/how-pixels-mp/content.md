...
pixels.set*all*rgb(255, 0, 0, 100)  # Red
pixels.show()
sleep(1)

pixels.set*all*color(ModulinoColor.GREEN, 100)
pixels.show()
sleep(1)

pixels.set*all*color(ModulinoColor.BLUE, 100)
pixels.show()
sleep(1)

# Knight Rider animation
def set*glowing*led(index, r, g, b, brightness):
    """
