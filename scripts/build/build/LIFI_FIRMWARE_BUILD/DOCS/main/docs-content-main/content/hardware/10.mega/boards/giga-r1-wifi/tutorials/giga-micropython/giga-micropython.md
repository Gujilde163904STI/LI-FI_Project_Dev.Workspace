...
- This specific [GIGAR1*MP*FW.dfu](/resources/firmware/GIGAR1*MP*FW.dfu) firmware.
...
**1.** Download the [GIGAR1*MP*FW.dfu](/resources/firmware/GIGAR1*MP*FW.dfu) firmware (latest firmware is always available at the [MicroPython with Arduino](/micropython/) page).
...
**4.** Open a terminal, and navigate to the directory of your `GIGAR1*MP*FW.dfu` file. Run the following command:
