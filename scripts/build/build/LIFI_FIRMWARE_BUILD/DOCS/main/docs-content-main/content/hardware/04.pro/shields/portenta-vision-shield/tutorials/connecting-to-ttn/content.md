...
coverImage: assets/vs*ard*things_nw.svg
...
![Finding the sketch](assets/vs*ard*ttn_standalone.png)

5. Open the Serial Monitor and wait for the update to be confirmed.

![Serial Monitor](assets/vs*ard*ttn_serial.png)
...
![Select Applications on the Console](assets/vs*ard*ttn_app.png)
...
![Select port M7 Core](assets/vs*ard*select_port.png)
...
![Upload code to IDE](assets/vs*ard*select_example.png)
...
![Entering the device EUI](assets/vs*ard*ttn*register*device_1.png)
