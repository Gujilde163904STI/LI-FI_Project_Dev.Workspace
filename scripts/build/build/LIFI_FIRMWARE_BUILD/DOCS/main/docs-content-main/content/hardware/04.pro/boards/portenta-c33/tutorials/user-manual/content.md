...
|       `9` or `SCK`      |          `P204`         |
|     `7` or `CS`/`SS`    |          `P402`         |
| `46` or `PIN*SPI1*MOSI` |          `P101`         |
| `45` or `PIN*SPI1*MISO` |          `P100`         |
|  `47` or `PIN*SPI1*SCK` |          `P102`         |
|  `48` or `PIN*SPI1*CS`  |          `P103`         |
...
You can download the example sketch [here](assets/portenta*c33*i2s*sine*wave.zip).
