...
![How to mount the MKR RGB Shield on top of an Arduino® MKR board.](assets/MKRRGB*T2*IMG01.png)
...
![Different levels of brightness on the LEDs.](assets/MKRRGB*T2*IMG02.png)
