...
![Encryption of MQTT.](assets/mkr*tutorial*11*img*03.png)
...
![Simple Publisher and Subscriber circuit.](assets/mkr*tutorial*11*img*01.png)
...
![Creating new tab.](assets/mkr*tutorial*11*img*04.png)

Then, name the file `"arduino_secrets.h"`.

![Naming the file.](assets/mkr*tutorial*11*img*05.png)

Inside this new header file, we need to use the below code, where our `SECRET*SSID` (network name) and `SECRET*PASS` (password) needs to be replaced by your own credentials.
...
![Selecting the board.](assets/mkr*tutorial*11*img*06.png)
...
![Serial Monitor output of publisher device.](assets/mkr*tutorial*11*img*07.png)
...
![Serial Monitor output of subscriber device.](assets/mkr*tutorial*11*img*08.png)
