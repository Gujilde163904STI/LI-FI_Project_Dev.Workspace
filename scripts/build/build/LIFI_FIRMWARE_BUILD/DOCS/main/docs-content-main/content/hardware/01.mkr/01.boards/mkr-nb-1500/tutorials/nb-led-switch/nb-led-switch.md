...
![Simple circuit with board and antenna.](assets/MKRNB*T1*IMG01.png)
...
![Waiting for messages.](assets/MKRNB*T1*IMG02.png)
...
![Message received, LED switched to either ON/OFF.](assets/MKRNB*T1*IMG03.png)
