...
![Arduino GIGA R1 WiFi Block Diagram](assets/GIGA*R1*WiFi*Block*Diagram.png)
...
The GIGA R1 WiFi's main processor is the dual-core STM32H747 (U1) including a Arm® Cortex®-M7 running at 480 MHz and a Arm® Cortex®-M4 running at 240 MHz. The two cores communicate via a *Remote Procedure Call* mechanism that allows calling functions between each processor seamlessly.
...
![Arduino GIGA R1 WiFi Power Tree](assets/GIGA*R1*WiFi*Power*Tree.png)
