...
Using the [Arduino*Graphics](https://github.com/arduino-libraries/ArduinoGraphics),[Arduino*GigaDisplay*GFX](https://github.com/arduino-libraries/Arduino*GigaDisplay_GFX) and [lvgl](https://github.com/lvgl/lvgl) we can also create animations and screen changes based on microphone data.
...
The [PDM library](https://docs.arduino.cc/learn/built-in-libraries/pdm) is included in the Board Package, as well as the video driver library, [Arduino*H7*Video library](https://github.com/arduino/ArduinoCore-mbed/tree/main/libraries/Arduino*H7*Video). Some examples in this guide uses other libraries that are listed in each example.
