...
![The nRF52840 module.](./assets/nano33BLE*04*sensor.png)
...
![Finding the library in the Cloud Editor.](./assets/nano33BLE*04*library.png)
...
![Selecting the board.](assets/nano33BLE*04*board_port.png)
...
![Serial Monitor output.](./assets/nano33BLE*04*printing_values.png)
...
![Accessing through a Bluetooth® phone app.](./assets/nano33BLE*04*application.png)
