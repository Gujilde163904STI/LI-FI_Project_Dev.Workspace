...
| V<sub>IH</sub>       | Input high-level voltage         | 0.7V<sub>DDIO*EXT</sub><sup>1</sup> |     | V<sub>DDIO*EXT</sub>                | V    |
...
![Nicla Voice Block Diagram](assets/niclaVoice*Block*Diagram.svg)
...
### Power Tree
![Nicla Voice Power Tree](assets/niclaVoice*Power*Tree.png)
...
![Nicla Family Bottom Fins](assets/nicla*bottom*fins.svg)
