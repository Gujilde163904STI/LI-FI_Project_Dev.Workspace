...
Start by making a new program, and give it a good name. For example: *01\*two\*sensors\*reader\*v0001*. This name reflects that this is the second program of the course (*01*) its name (*two\*sensors\*reader*) and the version number. You can develop your own technique on how to name files, but for the time being, let’s follow the one here shown.
...
*Figure 10: Code listing for the 01\*two\*sensors\*reader\*v0001 sketch*
