...
| `int parseInt()`                                                   | Reads characters from the serial buffer and converts them to an integer.                     | `int`     |
| `int peek()`                                                       | Returns the next byte in the serial buffer without removing it.                              | `int`     |
| `size*t print()`                                                   | Prints data to the serial port.                                                              | `size*t`  |
| `size*t println()`                                                 | Prints data to the serial port followed by a newline character.                              | `size*t`  |
| `int read()`                                                       | Reads the next byte from the serial buffer.                                                  | `int`     |
...
| `size*t write(uint8*t)`                                            | Writes a byte to the serial port.                                                            | `size_t`  |
...
| Method & Parameters                                               | Description                                                                       | Returns       |
| ----------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------- |
| `SPISettings(uint32*t clock, uint8*t bitOrder, uint8_t dataMode)` | Creates an SPISettings object with the specified clock, bit order, and data mode. | `SPISettings` |
...
| `size*t write(uint8*t data)`                 | Writes a byte to the I2C bus.                                                       | `size_t` |
| `int available()`                            | Returns the number of bytes available for reading.                                  | `int`    |
...
| `PinMode`   | `INPUT` / `OUTPUT` / `INPUT*PULLUP` /  `INPUT*PULLDOWN` / `OUTPUT_OPENDRAIN` | Constants for specifying pin modes (`0`, `1`, `2`, `3`, `4`). |
