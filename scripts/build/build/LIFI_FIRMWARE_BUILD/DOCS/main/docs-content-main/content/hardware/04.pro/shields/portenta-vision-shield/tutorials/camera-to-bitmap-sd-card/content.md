...
You can find the sketch on the latest version of the [Arduino*Pro*Tutorials](https://github.com/arduino-libraries/Arduino*Pro*Tutorials) at `examples > Vision Shield to SD Card bmp > visionShieldBitmap.ino`
