...
First, you need to download the library **Arduino*BHY2** in the Arduino IDE. Next, you need to upload the **App.ino** example sketch inside the library. This sketch can be found in: **Examples > Arduino*BHY2 > App.ino**. Select the sketch and upload it to your board.
