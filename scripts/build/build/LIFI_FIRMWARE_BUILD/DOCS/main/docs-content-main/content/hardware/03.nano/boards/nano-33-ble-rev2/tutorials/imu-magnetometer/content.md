...
### The Library
The [Arduino BMI270*BMM150 library](https://www.arduino.cc/reference/en/libraries/arduino*bmi270_bmm150/) allows us to use the Nano 33 BLE Rev2 IMU module without having to go into complicated programming. The library takes care of the sensor initialization and sets its values as follows:
...
![How a magnetometer works.](./assets/nano33B*04*magnetometer.png)
...
![Finding the library in the Cloud Editor.](./assets/nano33B*04*include_library.png)
...
![Selecting the board.](./assets/nano33B*04*board_port.png)
...
![Checking for magnetic disturbance.](./assets/nano33B*04*illustration.png)
