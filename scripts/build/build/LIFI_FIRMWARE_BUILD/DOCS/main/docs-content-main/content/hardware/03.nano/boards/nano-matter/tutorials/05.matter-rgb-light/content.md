...
- [Seeed*RGB*LED*Matrix](https://github.com/Seeed-Studio/Seeed*RGB*LED*Matrix) library to control the RGB LED matrix. You can install it as .ZIP using the Arduino IDE.

### Download the Project Code

[![ ](assets/download.png)](assets/matter*rgb*light.zip)

Download the complete project code [here](assets/matter*rgb*light.zip).
