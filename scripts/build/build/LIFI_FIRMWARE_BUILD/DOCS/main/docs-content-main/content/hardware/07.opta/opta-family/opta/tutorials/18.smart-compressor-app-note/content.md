...
- The [Compressor Monitor sketches for Opta and Nicla Sense ME](assets/Opta*Nicla*Codes.zip)
...
- [Application Arduino Sketches](assets/Opta*Nicla*Codes.zip)
...
You can download the code for the Opta PLC [here](assets/Opta*Nicla*Codes.zip).
...
***You can download the complete code from [here](assets/Opta*Nicla*Codes.zip).***

### Nicla Sense ME Code

You can download the code for the Nicla Sense ME [here](assets/Opta*Nicla*Codes.zip).
...
- `Arduino*BHY2.h` provides the APIs for Nicla Sense ME board sensors. Search for **Arduino*BHY2** in the Library Manager to install it.
...
- The complete code can be downloaded [here](assets/Opta*Nicla*Codes.zip)
