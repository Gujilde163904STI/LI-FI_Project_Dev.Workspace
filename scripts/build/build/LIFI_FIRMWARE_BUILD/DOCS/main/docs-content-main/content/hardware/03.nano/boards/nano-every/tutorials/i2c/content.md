...
First start by connecting your Arduino Nano Every board to the computer and opening the Arduino Create Cloud Editor. This board will act as the reader. Start a new sketch and name it **Nano*I2C*Reader**. 
...
![Nano tutorial I2C serial monitor.](./assets/nano33BS*06*printing_values.png)
