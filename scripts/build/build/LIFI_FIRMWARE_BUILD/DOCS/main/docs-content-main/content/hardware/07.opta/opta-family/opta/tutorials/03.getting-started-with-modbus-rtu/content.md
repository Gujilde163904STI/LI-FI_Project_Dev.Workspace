...
- [Modbus RTU example code](assets/Opta*Modbus*RTU_Example.zip)
...
You can access the complete example code [here](assets/Opta*Modbus*RTU*Example.zip); after extracting the files, `Opta*ModbusRTU*client` and `Opta*ModbusRTU_server` sketches are available to try with your Opta™ devices.
