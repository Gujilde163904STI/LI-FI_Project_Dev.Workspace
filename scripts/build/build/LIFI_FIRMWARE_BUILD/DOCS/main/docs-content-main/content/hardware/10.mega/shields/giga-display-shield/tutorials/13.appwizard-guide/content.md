...
Now the folder name needs to be removed from the `#include` directives of the generated files. Inside the **ID*SCREEN*00_Slots.c** file change the `#include "../Generated/Resource.h"`
and `#include "../Generated/ID*SCREEN*00.h"` to `#include "Resource.h"` and `#include "ID*SCREEN*00.h"`.
