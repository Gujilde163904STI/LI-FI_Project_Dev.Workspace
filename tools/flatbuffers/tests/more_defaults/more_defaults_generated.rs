...
impl<'a> MoreDefaults<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.bools {
            builder.add_bools(x);
        }
        if let Some(x) = args.abcs {
            builder.add_abcs(x);
        }
        if let Some(x) = args.some_string {
            builder.add_some_string(x);
        }
        if let Some(x) = args.empty_string {
            builder.add_empty_string(x);
        }
    ...
    pub fn empty_string(&self) -> &'a str {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(MoreDefaults::VT_EMPTY_STRING, Some(&""))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn abcs(&self) -> flatbuffers::Vector<'a, ABC> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, ABC>>>(
                    MoreDefaults::VT_ABCS,
                    Some(Default::default()),
                )
                .unwrap()
        }
...
impl flatbuffers::Verifiable for MoreDefaults<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, ABC>>>(
                "abcs",
                Self::VT_ABCS,
                false,
            )?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MoreDefaultsBuilder<'a, 'b, A> {
    ...
    pub fn add_ints(&mut self, ints: flatbuffers::WIPOffset<flatbuffers::Vector<'b, i32>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(MoreDefaults::VT_INTS, ints);
    }
    #[inline]
    pub fn add_floats(&mut self, floats: flatbuffers::WIPOffset<flatbuffers::Vector<'b, f32>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(MoreDefaults::VT_FLOATS, floats);
    }
    #[inline]
    pub fn add_empty_string(&mut self, empty_string: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            MoreDefaults::VT_EMPTY_STRING,
            empty_string,
        );
    }
    #[inline]
    ...
    pub fn add_abcs(&mut self, abcs: flatbuffers::WIPOffset<flatbuffers::Vector<'b, ABC>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(MoreDefaults::VT_ABCS, abcs);
    }
    #[inline]
    pub fn add_bools(&mut self, bools: flatbuffers::WIPOffset<flatbuffers::Vector<'b, bool>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(MoreDefaults::VT_BOOLS, bools);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> MoreDefaultsBuilder<'a, 'b, A> {
