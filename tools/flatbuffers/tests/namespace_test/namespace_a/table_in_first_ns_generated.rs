...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TableInFirstNSBuilder<'a, 'b, A> {
    ...
    pub fn add_foo_union(
        ...
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(TableInFirstNS::VT_FOO_UNION, foo_union);
    }
    #[inline]
...
impl TableInFirstNST {
    pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
        ...
        let foo_table = self.foo_table.as_ref().map(|x| x.pack(_fbb));
        let foo_enum = self.foo_enum;
