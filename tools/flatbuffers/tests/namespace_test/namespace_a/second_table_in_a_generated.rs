...
impl<'a> SecondTableInA<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.refer_to_c {
            builder.add_refer_to_c(x);
        }
        builder.finish()
    }

    pub fn unpack(&self) -> SecondTableInAT {
        let refer_to_c = self.refer_to_c().map(|x| Box::new(x.unpack()));
        SecondTableInAT { refer_to_c }
    }
    ...
    pub fn refer_to_c(&self) -> Option<super::namespace_c::TableInC<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<super::namespace_c::TableInC>>(
                    SecondTableInA::VT_REFER_TO_C,
                    None,
                )
        }
    }
...
impl flatbuffers::Verifiable for SecondTableInA<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<super::namespace_c::TableInC>>(
                "refer_to_c",
                Self::VT_REFER_TO_C,
                false,
            )?
...
impl<'a> Default for SecondTableInAArgs<'a> {
    #[inline]
    fn default() -> Self {
        SecondTableInAArgs { refer_to_c: None }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SecondTableInABuilder<'a, 'b, A> {
    #[inline]
    pub fn add_refer_to_c(
        &mut self,
        refer_to_c: flatbuffers::WIPOffset<super::namespace_c::TableInC<'b>>,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<super::namespace_c::TableInC>>(
                SecondTableInA::VT_REFER_TO_C,
                refer_to_c,
            );
    }
...
impl SecondTableInAT {
    pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
        ...
        let refer_to_c = self.refer_to_c.as_ref().map(|x| x.pack(_fbb));
        SecondTableInA::create(_fbb, &SecondTableInAArgs { refer_to_c })
    }
}
