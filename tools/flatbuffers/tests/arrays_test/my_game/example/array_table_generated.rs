...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ArrayTableBuilder<'a, 'b, A> {
    ...
    pub fn add_a(&mut self, a: &ArrayStruct) {
        self.fbb_
            .push_slot_always::<&ArrayStruct>(ArrayTable::VT_A, a);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> ArrayTableBuilder<'a, 'b, A> {
...
impl ArrayTableT {
    pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
        ...
        let a = a_tmp.as_ref();
        ArrayTable::create(_fbb, &ArrayTableArgs { a })
    }
}
#[inline]
...
pub fn size_prefixed_root_as_array_table(
    buf: &[u8],
) -> Result<ArrayTable, flatbuffers::InvalidFlatbuffer> {
