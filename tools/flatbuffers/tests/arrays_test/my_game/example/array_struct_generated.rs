...
impl<'b> flatbuffers::Push for ArrayStruct {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(
            self as *const ArrayStruct as *const u8,
...
impl<'a> ArrayStruct {
    ...
    pub fn new(a: f32, b: &[i32; 15], c: i8, d: &[NestedStruct; 2], e: i32, f: &[i64; 2]) -> Self {
    ...
    pub fn set_d(&mut self, x: &[NestedStruct; 2]) {
        ...
        // Which contains a valid array in this slot
        unsafe {
            core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(72), 64);
        }
    }
    ...
    pub fn unpack(&self) -> ArrayStructT {
        ArrayStructT {
            ...
            d: {
                let d = self.d();
                flatbuffers::array_init(|i| d.get(i).unpack())
            },
            e: self.e(),
            f: self.f().into(),
        }
