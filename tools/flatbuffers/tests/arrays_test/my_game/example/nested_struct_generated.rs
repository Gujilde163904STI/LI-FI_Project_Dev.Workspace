...
impl<'b> flatbuffers::Push for NestedStruct {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(
            self as *const NestedStruct as *const u8,
...
impl<'a> NestedStruct {
    ...
    pub fn new(a: &[i32; 2], b: TestEnum, c: &[TestEnum; 2], d: &[i64; 2]) -> Self {
        let mut s = Self([0; 32]);
        s.set_a(a);
        s.set_b(b);
        s.set_c(c);
    ...
    pub fn set_c(&mut self, x: &[TestEnum; 2]) {
        ...
        // Which contains a valid array in this slot
        unsafe {
            core::ptr::copy(x.as_ptr() as *const u8, self.0.as_mut_ptr().add(9), 2);
        }
    }
...
impl NestedStructT {
    pub fn pack(&self) -> NestedStruct {
        NestedStruct::new(&self.a, self.b, &self.c, &self.d)
    }
}
