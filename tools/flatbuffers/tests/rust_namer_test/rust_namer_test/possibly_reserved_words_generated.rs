...
impl<'b> flatbuffers::Push for PossiblyReservedWords {
    ...
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(
            self as *const PossiblyReservedWords as *const u8,
...
impl<'a> PossiblyReservedWords {
    ...
    pub fn new(follow_: f32, push_: f32, size: f32, alignment: f32) -> Self {
        let mut s = Self([0; 16]);
...
impl PossiblyReservedWordsT {
    pub fn pack(&self) -> PossiblyReservedWords {
        PossiblyReservedWords::new(self.follow_, self.push_, self.size, self.alignment)
    }
}
