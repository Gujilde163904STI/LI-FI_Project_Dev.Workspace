...
impl<'a> Table2<'a> {
    ...
    pub fn type_type(&self) -> KeywordsInUnion {
        ...
        unsafe {
            self._tab
                .get::<KeywordsInUnion>(Table2::VT_TYPE_TYPE, Some(KeywordsInUnion::NONE))
                .unwrap()
        }
    }
    #[inline]
    pub fn type_(&self) -> Option<flatbuffers::Table<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Table2::VT_TYPE_, None)
        }
    }
    #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> Table2Builder<'a, 'b, A> {
    ...
    pub fn add_type_type(&mut self, type_type: KeywordsInUnion) {
        self.fbb_.push_slot::<KeywordsInUnion>(
            Table2::VT_TYPE_TYPE,
            type_type,
    ...
    pub fn add_type_(&mut self, type_: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Table2::VT_TYPE_, type_);
    }
    #[inline]
...
impl Table2T {
    pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
        ...
        Table2::create(_fbb, &Table2Args { type_type, type_ })
    }
}
