...
impl<'a> KeywordsInTable<'a> {
    ...
    pub fn is(&self) -> ABC {
        ...
        unsafe {
            self._tab
                .get::<ABC>(KeywordsInTable::VT_IS, Some(ABC::void))
                .unwrap()
        }
    }
    #[inline]
    pub fn private(&self) -> public {
        ...
        unsafe {
            self._tab
                .get::<public>(KeywordsInTable::VT_PRIVATE, Some(public::NONE))
                .unwrap()
        }
    }
    #[inline]
    pub fn type_(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(KeywordsInTable::VT_TYPE_, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn default(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(KeywordsInTable::VT_DEFAULT, Some(false))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> KeywordsInTableBuilder<'a, 'b, A> {
    ...
    pub fn add_is(&mut self, is: ABC) {
        self.fbb_
            .push_slot::<ABC>(KeywordsInTable::VT_IS, is, ABC::void);
    }
    #[inline]
    pub fn add_private(&mut self, private: public) {
        self.fbb_
            .push_slot::<public>(KeywordsInTable::VT_PRIVATE, private, public::NONE);
    }
    #[inline]
    pub fn add_type_(&mut self, type_: i32) {
        self.fbb_
            .push_slot::<i32>(KeywordsInTable::VT_TYPE_, type_, 0);
    }
    #[inline]
    pub fn add_default(&mut self, default: bool) {
        self.fbb_
            .push_slot::<bool>(KeywordsInTable::VT_DEFAULT, default, false);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> KeywordsInTableBuilder<'a, 'b, A> {
