...
- Project detection now based on pico*sdk*init() in the CMakeLists.txt, rather than pico*sdk*import.cmake file
...
- Added support for looking into PICO*BOARD*HEADER_DIRS when switching board (#123)
...
- Make c*cpp*properties platform independent (#1)
...
- Fix PICO*TOOLCHAIN*PATH in Windows integrated terminal
...
- dev*hid*composite and dev_lowlevel examples (@will-v-pi)
