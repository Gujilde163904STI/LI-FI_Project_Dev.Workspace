...
| :----- | :-------------------- | :---------- | :------ |
| 2020-11-30 | [vsky279](https://github.com/vsky279) | [vsky279](https://github.com/vsky279) | [file*lfs.lua](../../lua*modules/file*lfs/file*lfs.lua)|
...
Files to be stored in LFS needs to be preprocessed, i.e. a Lua file with its contents needs to be generated. This file called `resource.lua` is then included in the LFS image. A Lua script [`make*resource.lua`](../../lua*modules/file*lfs/make*resource.lua) can be used to generate `resource.lua` script.
