...
#### Syntax
`imap.fetch*header(socket, msg*number, field)`
...
#### Example
Example use of `imap` module can be found in  [read*email*imap.lua](../../lua*examples/email/read*email_imap.lua) file.
