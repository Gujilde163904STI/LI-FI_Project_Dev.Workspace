...
| :----- | :-------------------- | :---------- | :------ |
| 2016-02-20 | [Espressif example](http://bbs.espressif.com/viewtopic.php?t=49), [Arnim Läuger](https://github.com/devsaurus) | [Arnim Läuger](https://github.com/devsaurus) | [sigma*delta.c](../../app/modules/sigma*delta.c)|
...
The signal generation is controlled by the [`setprescale()`](#sigma*deltasetprescale) and [`settarget()`](#sigma*deltasettarget) functions.
...
#### See also
[`sigma*delta.settarget()`](#sigma*deltasettarget)
...
#### See also
[`sigma*delta.setprescale()`](#sigma*deltasetprescale)
