...
- On Windows systems, `FindSystemTimeZoneById` attempts to match the subkey names under the registry branch `HKEY*LOCAL*MACHINE\Software\Microsoft\Windows NT\CurrentVersion\Time Zones`.
