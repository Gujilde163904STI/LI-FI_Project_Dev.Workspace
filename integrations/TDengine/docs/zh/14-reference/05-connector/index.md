...
import InstallOnLinux from "./*linux*install.mdx";
import InstallOnWindows from "./*windows*install.mdx";
import InstallOnMacOS from "./*macos*install.mdx";
import VerifyWindows from "./*verify*windows.mdx";
import VerifyLinux from "./*verify*linux.mdx";
import VerifyMacOS from "./*verify*macos.mdx";
