...
*block*dist: Total*Blocks=[5] Total*Size=[93.65 KB] Average*size=[18.73 KB] Compression*Ratio=[23.98 %]
...
*block*dist: Total*Rows=[20000] Inmem*Rows=[0] MinRows=[3616] MaxRows=[4096] Average_Rows=[4000]
...
*block*dist: Total*Tables=[1] Total*Files=[2] Total_Vgroups=[1]
