...
Containers don't have [GUI](https://en.wikipedia.org/wiki/Graphical*user*interface)s so generally the way you interact with them is via web services or you can launch into a terminal.
