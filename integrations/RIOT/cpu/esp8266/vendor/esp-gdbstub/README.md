...
`COMPONENTS*eagle.app.v6` define. Also, you probably want to add `-ggdb` to your compiler flags (`TARGET*LDFLAGS`)
 ...
 * In your user*main.c, add an `#include <../gdbstub/gdbstub.h>` and call `gdbstub*init();` somewhere in user_main.
