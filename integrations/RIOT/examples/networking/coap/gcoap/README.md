...
which are based on the [SLIP instructions][3] for the gnrc*border*router
...
[3]: https://github.com/RIOT-OS/RIOT/tree/master/examples/networking/gnrc/gnrc*border*router    "SLIP instructions"
