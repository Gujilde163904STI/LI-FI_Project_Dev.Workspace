...
### gnrc*pktbuf*duplicate_upto() [b83430aa625a1d42f11f9badf5e5cfbb8efacd99]
Author(s):
...
- its only user within the RIOT code base `gnrc*ipv6*ext` was reworked in
...
### boards/wsn430-v1*3b, boards/wsn430-v1*4 [e63cd54f3b1e002a7895bb7c46af889b341c1a15]
...
### GNRC*NETTYPE*IOVEC [4f243c52eabefe709d78560ce7f1d502d737a999]
Author(s):
- Martine S. Lenders <m.lenders@fu-berlin.de>
...
### pkg/nordic*softdevice*ble [35b6ccedf31f10a5f8e4f97609ad5b10c28bdc34]
Author(s):
- Hauke Petersen <hauke.petersen@fu-berlin.de>
- Kaspar Schleiser <kaspar@schleiser.de>
- Martine Lenders <m.lenders@fu-berlin.de>
...
### gnrc*pktbuf*replace_snip() [72821a502f073006643cb4ef7815fc8c42563ce6]
Author(s):
