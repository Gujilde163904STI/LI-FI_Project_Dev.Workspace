...
Adapt pin configuration in Makefile to match the used CAN transceiver (e.g. TJA1042*STB*PIN)
...
To set a CAN transceiver device's (trx*id = 0) mode to TRX*NORMAL_MODE
```
set_mode 0 0
```
