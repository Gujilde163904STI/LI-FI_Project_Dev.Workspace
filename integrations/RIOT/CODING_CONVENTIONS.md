...
* In order to follow Linux's recommendation on
  ...
  make use of `IS*ACTIVE` and `IS*USED` macros from `kernel_defines.h` with C
...
- "sys/include/net/gnrc/pkt.h" -> NET*GNRC*PKT_H
- "drivers/abcd0815/abcd0815*params.h" -> ABCD0815*PARAMS_H
- "sys/module/*internal.h" -> PRIV*INTERNAL_H
