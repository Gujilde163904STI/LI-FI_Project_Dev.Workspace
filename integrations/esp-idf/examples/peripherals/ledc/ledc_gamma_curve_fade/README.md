...
Running this example, you will see color and brightness difference between two RGB LEDs during fading. This is because on RGB*LED*1, no gamma correction is applied; while on RGB*LED*2, gamma correction is applied, and it is fading fitting to a gamma curve. Overall, the color change on RGB*LED*2 should look more gradual and smoother to human eyes.
