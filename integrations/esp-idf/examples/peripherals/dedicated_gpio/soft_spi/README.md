...
Due to the tight timing requirements of SW bit banging, the `asm*emulate*spi` function has been placed in IRAM. This circumvents the timing variations caused by cache misses/invalidation when executing a function placed in flash.
