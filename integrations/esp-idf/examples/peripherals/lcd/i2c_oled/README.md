...
This example shows how to make use of the SSD1306 panel driver from `esp*lcd` component to facilitate the porting of LVGL library. In the end, example will display a scrolling text on the OLED screen. For more information about porting the LVGL library, you can also refer to another [lvgl porting example](../i80*controller/README.md).
