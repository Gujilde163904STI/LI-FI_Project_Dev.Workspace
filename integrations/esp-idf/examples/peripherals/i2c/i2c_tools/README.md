...
**Note:** The following pin assignments are used by default according to `CONFIG*I2C*MASTER*SCL` and `CONFIG*I2C*MASTER*SDA` , you can change them with `i2cconfig` command at any time.
