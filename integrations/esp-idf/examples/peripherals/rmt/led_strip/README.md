...
This example shows how to drive an addressable LED strip [WS2812](https://cdn-shop.adafruit.com/datasheets/WS2812B.pdf) by implementing the [led*strip*encoder](main/led*strip*encoder.c).
...
After you seeing this log, you should see a rainbow chasing demonstration pattern. To change the chasing speed, you can update the `EXAMPLE*CHASE*SPEED*MS` value in [source file](main/led*strip*example*main.c).
