...
The GPIO number used in this example can be changed according to your board, by the macro `DSHOT*ESC*GPIO*NUM` defined in the [source file](main/dshot*esc*example*main.c).
