...
The TX and RX GPIO number used by this example can be changed in [the source file](main/ir*nec*transceiver*main.c) via `EXAMPLE*IR*TX*GPIO*NUM` and `EXAMPLE*IR*RX*GPIO_NUM`.
