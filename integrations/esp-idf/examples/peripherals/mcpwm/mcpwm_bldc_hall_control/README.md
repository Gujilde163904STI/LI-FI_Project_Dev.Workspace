...
You can change the GPIO number in the [example code](main/mcpwm*bldc*hall*control*example*main.c) according to your board. You can define the spin direction in the code as well by the `BLDC*SPIN*DIRECTION*CCW` macro.
