...
This example illustrates how to drive a typical [RC Servo](https://en.wikipedia.org/wiki/Servo*%28radio*control%29) by sending a PWM signal using the MCPWM driver. The PWM pulse has a frequency of 50Hz (period of 20ms), and the active-high time (which controls the rotation) ranges from 0.5s to 2.5ms with 1.5ms always being center of range.
...
* A RC servo motor, e.g. [SG90](http://www.ee.ic.ac.uk/pcheung/teaching/DE1*EE/stores/sg90*datasheet.pdf)
