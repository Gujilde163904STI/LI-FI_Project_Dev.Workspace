...
The example uses a simple PID algorithm to keep the motor spin in a stable speed. Like the [bdc*motor](https://components.espressif.com/component/espressif/bdc*motor), the [PID component](https://components.espressif.com/component/espressif/pid*ctrl) is also managed by the component manager. These components' dependencies are listed in the [manifest file](main/idf*component.yml).
...
![bdc*speed*dashboard](bdc*speed*dashboard.png)
