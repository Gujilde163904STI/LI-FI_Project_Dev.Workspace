...
The digital PDM microphone is connected on the I2S interface `I2S*NUM*0`.
...
Running this example, you will see the Bits per Sample changes every 5 seconds after you have run this example. You can use `i2s*set*clk` to change the Bits per Sample and the Sample Rate. The output log can be seen below:
