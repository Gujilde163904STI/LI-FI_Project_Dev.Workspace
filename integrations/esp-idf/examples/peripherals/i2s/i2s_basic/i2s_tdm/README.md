...
There are simplex mode and duplex mode can be chosen in this example, setting `EXAMPLE*I2S*DUPLEX_MODE` to `0` will adopt the simplex mode, otherwise it will adopt the full-duplex mode.
