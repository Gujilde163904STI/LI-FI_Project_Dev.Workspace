...
* Set `EXAMPLE*TCP*SERVER` to use the example as a non-blocking TCP server
...
* Set `EXAMPLE*TCP*CLIENT` to use the example as a non-blocking TCP client
...
Follow the same troubleshooting instruction as for the standard [TCP sever](../tcp*server/README.md) and the [TCP client](../tcp*client/README.md),
