...
* i) Install the [esp*secure*cert configuration utility](https://github.com/espressif/esp*secure*cert*mgr/tree/main/tools#esp*secure_cert-configuration-tool) with following command:
```
...
> Note: More details about the `esp-secure-cert-tool` utility can be found [here](https://github.com/espressif/esp*secure*cert_mgr/tree/main/tools).
