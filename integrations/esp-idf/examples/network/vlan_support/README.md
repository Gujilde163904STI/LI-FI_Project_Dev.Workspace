...
Note: The code in vlan*support*main.c can be modified to add more vlan interfaces. The maximum number of interfaces that can be added is specified by the macro `MAX*ETH*NETIF_COUNT`.
## How to use example
