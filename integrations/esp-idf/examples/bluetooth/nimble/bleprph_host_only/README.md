...
This example uses the UART transport written by application itself. Refer the file [main/uart*driver.c](main/uart*driver.c).
...
There is this console output when bleprph*host*only running on esp32 and using controller of esp32c6:
