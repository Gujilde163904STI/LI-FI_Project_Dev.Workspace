...
For detailed description information, please refer to `components/bt/include/esp32/include/esp*bt*vs.h`.
...
In a frequently-used scenario, if ESP*Test Board is used, connect the TX0, RX0, RTS0, CTS0 and GND of ESP*Test Board to ESP32 UART1 or UART2 PINs, and Attach ESP_Test board to the host PC.
