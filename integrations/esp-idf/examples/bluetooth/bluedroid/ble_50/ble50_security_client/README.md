...
To test this demo, you can run the [ble50*security*server*demo](../ble50*security_server), which starts advertising and can be connected to
...
Please, check this [tutorial](tutorial/ble50*security*client*Example*Walkthrough.md) for more information about this example.
