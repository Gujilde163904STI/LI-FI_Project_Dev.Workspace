...
This example is modified based on [bt*discovery](../../classic*bt/bt_discovery), and all modifications are listed below:
...
- Add support for uart driver: `uart*driver.c` and `uart*driver.h`.
...
This example should be able to run on any commonly available ESP development board. To connect UART to another board running a Bluetooth controller. For example, [controller*hci*uart*esp32](../../../hci/controller*hci*uart*esp32).
