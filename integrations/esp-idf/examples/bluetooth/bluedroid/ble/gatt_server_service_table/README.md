...
This example shows how to create a GATT service with an attribute table defined in one place. Provided API releases the user from adding attributes one by one as implemented in BLUEDROID. A demo of the other method to create the attribute table is presented in [gatt*server*demo](../gatt_server).

Please, check this [tutorial](tutorial/Gatt*Server*Service*Table*Example_Walkthrough.md) for more information about this example.
