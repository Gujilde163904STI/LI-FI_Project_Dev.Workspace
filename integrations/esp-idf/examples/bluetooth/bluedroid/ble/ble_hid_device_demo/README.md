...
* `esp*hidd*prf*api.h` & `esp*hidd*prf*api.c`
These files contains the the api of the HID profile
When you used the HID profile, you just need to added the esp*hidd*prf*api.h includes file and send the HID data used the function defined in the esp*hidd*prf*api.c file.
