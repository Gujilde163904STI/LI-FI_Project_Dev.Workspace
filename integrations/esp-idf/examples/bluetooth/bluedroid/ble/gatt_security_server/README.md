...
To test this example, you can run [gatt*security*client*demo](../gatt*security*client), which starts scanning, connects to and starts encryption with `gatt*security*server*demo` automatically.

Please, check this [tutorial](tutorial/Gatt*Security*Server*Example*Walkthrough.md) for more information about this example.
