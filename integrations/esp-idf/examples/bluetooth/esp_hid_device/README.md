...
This demo use APIs which esp*hid component provided to create a BT, BLE or Bluetooth dual mode hid device. Users can choose mode by setting `HID*DEV_MODE`.


This example works in companion with the [BLE HID Host Example](../esp*hid*host/README.md)
...
1. When using NimBLE stack, some iOS devices do not show the volume pop up. To fix this, please set CONFIG*BT*NIMBLE*SM*LVL to value 2. iOS needs Authenticated Pairing with Encryption to show up the pop ups.
