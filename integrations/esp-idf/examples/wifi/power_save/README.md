...
![current consumption with CONFIG*PM*ENABLE enabled](image/power*save*graph.png)

### Typical current consumption with management disabled

![current consumption with CONFIG*PM*ENABLE disabled](image/power*save*graph*PM*disabled.png)
