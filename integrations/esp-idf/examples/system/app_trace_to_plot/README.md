...
- For ESP32-C3 or ESP32-S3, any board with the built-in USB interface (USB*SERIAL*JTAG).
...
2. To start the tcp socket server, you need to run `read*trace.py` tool under the `esp-idf/examples/system/app*trace*to*plot` path.
...
| x*axis*data_size | Data size of x axis of the incoming packet in bytes (e.g 2, 4, 8)                                                                                                                 |
| x*axis*timestamp | Will x axis data be timestamp value (e.g. true, false)                                                                                                                            |
| y*axis*data_size | Data size of y axis of the incoming packet in bytes (e.g 2, 4, 8)                                                                                                                 |
...
**Note** y*axis*value and x*axis*value could be in any value and different sizes like long, short, and int. The only thing to do is enter the correct data size in the config file.
