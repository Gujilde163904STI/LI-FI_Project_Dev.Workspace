...
2. The function `spiffs*create*partition_image` is used to specify that a SPIFFS image
...
The logic of the example is contained in a [single source file](./main/spiffsgen*example*main.c), and it should be relatively simple to match points in its execution with the log outputs above.
