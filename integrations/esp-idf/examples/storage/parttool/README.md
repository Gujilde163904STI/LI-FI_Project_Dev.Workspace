...
Users taking a look at this example should focus on the contents of the Python script [parttool*example.py](parttool*example.py) or shell script [parttool*example.sh](parttool*example.sh). The scripts contain
...
### Running [parttool*example.py](parttool*example.py)

The example can be executed by running the script [parttool*example.py](parttool*example.py) or [parttool*example.sh](parttool*example.sh).
