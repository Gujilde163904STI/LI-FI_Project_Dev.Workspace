...
Note: This test is a pure hal i2c test. It CANNOT work with i2c driver in `esp*driver*i2c`.
...
For the actual default value of `I2C*MASTER*SDA` and `I2C*MASTER*SCL` see `test Configuration` in `menuconfig`.
