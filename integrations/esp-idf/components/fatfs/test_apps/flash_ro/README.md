...
- `create*test*files` function creates a set of files expected by the test cases
- `fatfs*create*rawflash_image` generates a FAT image from the set of files (via `fatfsgen.py`)
