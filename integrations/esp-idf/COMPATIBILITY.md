...
Note: IDF v5.1.5 and v5.3.2 are compatible with C2 v2.0. However the chip revision check hasn't been updated on these releases. Enable `ESP32C2*REV2*DEVELOPMENT` config to bypass the outdated check.
