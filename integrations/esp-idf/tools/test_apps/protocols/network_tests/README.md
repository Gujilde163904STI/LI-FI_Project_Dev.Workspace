...
* Copy files `esp32*netsuite.cfg` and `esp32*netsuite.ttcn` (located in `$IDF*PATH/components/lwip/weekend*test`) to `src` subdir of the cloned repository `net-test-suites`
