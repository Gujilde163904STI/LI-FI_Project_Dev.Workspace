...
- Initial implementation of advanced types ([#18794](https://github.com/apache/superset/pull/18794))
	- Flag: `ENABLE*ADVANCED*DATA_TYPES`
...
- The `ENABLE*JAVASCRIPT*CONTROLS` flag was moved from an app config to a feature flag
