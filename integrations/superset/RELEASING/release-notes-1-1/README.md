...
![Force Directed Graph](media/force*directed*graph.jpg)
...
- feat: add sort*by*metric for charts with single metric (#[13058](https://github.com/apache/superset/pull/13058))
...
- feat: Adding option to `set*database*uri` CLI command (#[12740](https://github.com/apache/superset/pull/12740))
