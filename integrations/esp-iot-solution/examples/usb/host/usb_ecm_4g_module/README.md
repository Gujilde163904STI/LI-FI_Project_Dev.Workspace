...
For devices where ECM is not on the default configuration descriptor 1, please enable `CONFIG*USB*HOST*ENABLE*ENUM*FILTER*CALLBACK` in menuconfig, such as CH397A.
