...
This example demonstrates how to use [iot*usbh*rndis](https://components.espressif.com/components/espressif/iot*usbh*rndis) to connect to 4G module with RNDIS protocol.
