...
This example demonstrates how to use relinker by the [cmake*utilities](https://components.espressif.com/components/espressif/cmake*utilities) component.

## How to use the example

The example is a copy of [bleprph*wifi*coex](https://github.com/espressif/esp-idf/tree/master/examples/bluetooth/nimble/bleprph*wifi*coex). Please refer the [README.md](https://github.com/espressif/esp-idf/tree/master/examples/bluetooth/nimble/bleprph*wifi*coex/README.md) for setup details.
...
To test this demo, any BLE scanner app and a WiFi access point with internet connectivity can be used. Please refer the [README.md](https://github.com/espressif/esp-idf/tree/master/examples/bluetooth/nimble/bleprph*wifi*coex/README.md) for setup details.
