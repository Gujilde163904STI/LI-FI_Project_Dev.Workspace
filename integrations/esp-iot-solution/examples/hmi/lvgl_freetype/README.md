...
* `BSP*LCD*SUB_BOARD`: Choose a LCD subboard according to hardware. Default use subboard3 (800x480).
* More configurations see BSP's [README](https://github.com/espressif/esp-bsp/tree/master/bsp/esp32*s3*lcd*ev*board#bsp-esp32-s3-lcd-ev-board).
