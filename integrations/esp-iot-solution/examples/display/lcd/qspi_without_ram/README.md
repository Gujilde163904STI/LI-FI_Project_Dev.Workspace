...
The LCD parameters and GPIO number used by this example can be changed in [lvgl*port.h](main/lvgl*port.h).
...
|    Version of LVGL     |               v8.3.9               |
|   Test Demo of LVGL    |            Music player            |
|  Basic Configurations  | sdkconfig.defaults.psram*octal*ddr |
...
|     Mode3      |  Full-refresh with two frame-size PSRAM buffers   | sdkconfig.test.full*refresh*1 |
|     Mode4      |   Direct-mode with two frame-size PSRAM buffers   |  sdkconfig.test.direct_mode   |
|     Mode5      | Full-refresh with three frame-size PSRAM buffers  | sdkconfig.test.full*refresh*2 |
