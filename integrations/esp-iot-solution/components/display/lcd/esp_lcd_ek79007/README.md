...
[![Component Registry](https://components.espressif.com/components/espressif/esp*lcd*ek79007/badge.svg)](https://components.espressif.com/components/espressif/esp*lcd*ek79007)

Implementation of the EK79007 LCD controller with esp_lcd component.

| LCD controller | Communication interface | Component name |                                   Link to datasheet                                   |
| :------------: | :---------------------: | :------------: | :-----------------------------------------------------------------------------------: |
|     EK79007     |        MIPI-DSI         | esp*lcd*ek79007 | [PDF](https://dl.espressif.com/AE/esp-iot-solution/EK79007.pdf) |
