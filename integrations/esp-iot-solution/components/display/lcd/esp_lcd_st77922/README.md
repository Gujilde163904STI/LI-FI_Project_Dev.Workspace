...
[![Component Registry](https://components.espressif.com/components/espressif/esp*lcd*st77922/badge.svg)](https://components.espressif.com/components/espressif/esp*lcd*st77922)
...
| :------------: | :---------------------: | :------------: | :---------------------------------------------------------------------------: |
|     ST77922     |        SPI/QSPI/MIPI-DSI         | esp*lcd*st77922 | [PDF](https://dl.espressif.com/AE/esp-iot-solution/ST77922*SPEC*V0.1.pdf) |
...
* When using `esp*panel*lcd*draw*bitmap()` to refresh the screen, ensure that both `x*start` and `x*end` are divisible by `4`. This is a requirement of ST77922. For LVGL, register the following function into `rounder*cb` of `lv*disp*drv*t` to round the coordinates.
