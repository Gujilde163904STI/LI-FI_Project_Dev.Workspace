...
* In progress -> master
* major*version.x -> rel/major*version （eg 0.9.x -> rel/0.9）
...
* Cut out a new branch from master. The branch name is determined by the function of this branch. It is usually called f*new*feature (such as f*storage*engine) or fix*bug (such as fix*query*cache*bug).
