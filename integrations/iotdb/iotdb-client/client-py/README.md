...
The Insert of aligned timeseries uses interfaces like insert*aligned*XXX, and others are similar to the above interfaces:

* insert*aligned*record
* insert*aligned*records
* insert*aligned*records*of*one_device
* insert*aligned*tablet
* insert*aligned*tablets
