...
* `IOTJS*WORKING*DIR_PATH` is the specified current working directory path to change the root of the module load.
* `IOTJS*EXTRA*MODULE_PATH` contains the paths to be additionally referenced to load any module.
